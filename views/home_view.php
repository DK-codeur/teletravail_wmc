        ...
        <div class="page-wrapper">
            ...
            <div class="container">
                <div class="row m-t-40">
                    ...
                    <!-- Column -->
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <a href="#" data-target="#createMember" data-toggle="modal" data-original-title="create">
                            <div class="card card-hover">
                    ...
                    <div class="modal-content">
                        <form>
                            <div class="modal-header">
                                <h5 class="modal-title" id="createModalLabel"><i class="ti-marker-alt m-r-10"></i> Modifier Membre</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="input-group mb-3">
                                    <button type="button" class="btn btn-info"><i class="ti-email text-white"></i></button>
                                    <input type="text" class="form-control" placeholder="Ville/commune" aria-label="ville">
                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-success"><i class="ti-save"></i> Modifier</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <!-- create member modal -->
            <div class="modal fade" id="createMember" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form>
                            <div class="modal-header">
                                <h5 class="modal-title" id="createModalLabel"><i class="ti-marker-alt m-r-10"></i> Ajouter un Nouveau Membre</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="input-group mb-3">
                                    <button type="button" class="btn btn-info"><i class="ti-calendar text-white"></i></button>
                                    <input type="text" onfocus="(this.type = 'date')" class="form-control" placeholder="Date de naissance" aria-label="date">
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
                                <button type="submit" class="btn btn-success"><i class="ti-save"></i> Ajouter</button>
                            </div>
                        </form>
                    </div>
                </div>
